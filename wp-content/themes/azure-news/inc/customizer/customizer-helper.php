    ...
    if ( ! function_exists( 'azure_news_upgrade_choices' ) ) :
        ...
        function azure_news_upgrade_choices( $setting_id ) {
            ...
            $upgrade_info_lists = array(
                'preloader'     => array( __( "15+ Styles <div class='hover-img' data-src='preloader-pro.jpg'><span class='hover-icon'><i class='bx bx-info-circle'></i></span></div>", 'azure-news' ), __( 'Color options', 'azure-news' ), __( 'Device visibility', 'azure-news' ) ),
                ...
                'main_banner'    => array( __( "2 More Layouts <div class='hover-img' data-src='banner-pro-layout.png'><span class='hover-icon'><i class='bx bx-info-circle'></i></span></div>", 'azure-news' ), __( 'Multiple Categories Option', 'azure-news' ), __( 'Extra option for slider control.', 'azure-news' ) ),
