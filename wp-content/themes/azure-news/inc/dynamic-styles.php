    ...
    if ( ! function_exists( 'azure_news_general_css' ) ) :
        ...
        function azure_news_general_css( $output_css ) {
            ...
            foreach ( $get_categories as $category ) {
                ...
                $custom_css .= ".block-posts-wrapper .post-cats-wrap .post-cats-list .post-cat-item.cat-". absint( $get_term_id ) ." a, .trending-posts-wrapper .post-content-wrap .post-cat-item.cat-". absint( $get_term_id ) ." a, .azure-news-banner-wrapper .lSSlideWrapper .post-cat-item.cat-". absint( $get_term_id ) ." a, .azure-news-banner-wrapper .block-wrapper .post-cat-item.cat-". absint( $get_term_id ) ." a, .azure-news-post-content-wrap .post-cats-wrap .post-cat-item.cat-". absint( $get_term_id ) ." a,  .latest-posts-wrapper .post-content-wrap .post-cat-item.cat-".absint( $get_term_id ) ." a, .related-posts-wrapper .post-cats-wrap .post-cat-item.cat-".absint( $get_term_id ) ." a{ color: ". esc_attr( $get_cat_color ) ."}\n";

                $custom_css .= ".block-posts-wrapper .post-cats-wrap .post-cats-list .post-cat-item.cat-". absint( $get_term_id ) ." a, .trending-posts-wrapper .post-content-wrap .post-cat-item.cat-". absint( $get_term_id ) ." a, .azure-news-banner-wrapper .lSSlideWrapper .post-cat-item.cat-". absint( $get_term_id ) ." a, .azure-news-banner-wrapper .block-wrapper .post-cat-item.cat-". absint( $get_term_id ) ." a, .azure-news-post-content-wrap .post-cats-wrap .post-cat-item.cat-". absint( $get_term_id ) ." a, .latest-posts-wrapper .post-content-wrap .post-cat-item.cat-". absint( $get_term_id ) ." a, .related-posts-wrapper .post-cats-wrap .post-cat-item.cat-". absint( $get_term_id ) ." a { background-image: linear-gradient(". esc_attr( $get_cat_color ) .", ". esc_attr( $get_cat_color ) .")}\n";
            }
