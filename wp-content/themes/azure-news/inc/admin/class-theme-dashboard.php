...
<?php
    ...
    public function azure_news_starter_screen() {
        ...
        $demodata = array(
            ...
            array(
                'name'              => __( 'Azure Mag', 'azure-news' ),
                'theme_slug'        => 'azure-mag',
                'preview_screen'    => 'https://codevibrant.com/demo-data/azure-news/azure-mag/screenshot.jpg',
        ...
        if ( $is_child_theme ) {
            $demodata = array(
                array(
                    ...
                    'preview_screen'    => get_stylesheet_directory_uri(). '/screenshot.png',
                    'preview_url'       => 'https://demo.codevibrant.com/'.$this->theme_slug
                ),
                array(
                    'name'              => __( 'Azure Pro', 'azure-news' ),
                    'theme_slug'        => 'azure-pro',
